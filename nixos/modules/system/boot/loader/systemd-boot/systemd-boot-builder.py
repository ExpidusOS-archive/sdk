...
def main() -> None:
    parser = argparse.ArgumentParser(description='Update ExpidusOS-related systemd-boot files')
    parser.add_argument('default_config', metavar='DEFAULT-CONFIG', help='The default ExpidusOS config to boot')
