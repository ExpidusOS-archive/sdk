# Sourced from https://github.com/NixOS/nixpkgs/blob/22.05/nixos/modules/system/activation/top-level.nix
...
let
  ...
  systemBuilder =
    ...
    in ''
      ...
      substituteAll ${(nixpkgs + "/nixos/modules/system/activation/switch-to-configuration.pl")} $out/bin/switch-to-configuration
  ...
  baseSystem = pkgs.stdenvNoCC.mkDerivation {
    ...
    expidusLabel = (import ../../../../lib/trivial.nix { inherit lib; }).version;
  ...
  config = {
    ...
    system.extraSystemBuilderCmds =
      optionalString
        ...
        ''ln -s '${(import ../../../lib/from-env.nix { inherit (lib.expidus.channels) nixpkgs; }) "NIXOS_CONFIG" <nixos-config>}' \
