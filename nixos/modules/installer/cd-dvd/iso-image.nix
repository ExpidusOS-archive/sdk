...
let
  ...
  let
    finalCfg = {
      name = "ExpidusOS ${lib.expidus.trivial.codeName} ${lib.expidus.trivial.version}${config.isoImage.appendToMenuLabel}";
  ...
  baseIsolinuxCfg = ''
    ...
    LABEL boot
    MENU LABEL ExpidusOS ${lib.expidus.trivial.codeName} ${lib.expidus.trivial.version}${config.isoImage.appendToMenuLabel}
    ...
    MENU LABEL ExpidusOS ${lib.expidus.trivial.codeName} ${lib.expidus.trivial.version}${config.isoImage.appendToMenuLabel} (nomodeset)
    LINUX /boot/${config.system.boot.loader.kernelFile}
    ...
    MENU LABEL ExpidusOS ${lib.expidus.trivial.codeName} ${lib.expidus.trivial.version}${config.isoImage.appendToMenuLabel} (copytoram)
    LINUX /boot/${config.system.boot.loader.kernelFile}
    ...
    LABEL boot-debug
    MENU LABEL ExpidusOS ${lib.expidus.trivial.codeName} ${lib.expidus.trivial.version}${config.isoImage.appendToMenuLabel} (debug)
    LINUX /boot/${config.system.boot.loader.kernelFile}
    ...
    LABEL boot-serial
    MENU LABEL ExpidusOS ${lib.expidus.trivial.codeName} ${lib.expidus.trivial.version}${config.isoImage.appendToMenuLabel} (serial console=ttyS0,115200n8)
    LINUX /boot/${config.system.boot.loader.kernelFile}
  ...
  options = {
    ...
    isoImage.appendToMenuLabel = mkOption {
      ...
      description = ''
        ...
        <para><literal>ExpidusOS 99.99-alpha</literal></para>
      '';
    };
  ...
  config = {
    ...
    isoImage.contents =
      [
        ...
        { source = pkgs.writeText "version" lib.expidus.trivial.version;
          target = "/version.txt";
        }
